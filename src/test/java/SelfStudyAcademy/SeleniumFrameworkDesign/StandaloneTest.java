...
public class StandaloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("davidVelez93@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("davidVelez93");
		...
		WebElement cartMenu = driver.findElement(By.cssSelector("[routerLink*='cart']"));
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("PAILAAAAAAAAAAAAAAAAA");
		}
